...
public class OmsCartItem implements Serializable {
    ...
    @ApiModelProperty(value = "product pictures")
    private String productPic;

    @ApiModelProperty(value = "product names")
    ...
    @ApiModelProperty(value = "product sale properties:[{'key':'color','value':'color'},{'key':'capacity','value':'4G'}]")
