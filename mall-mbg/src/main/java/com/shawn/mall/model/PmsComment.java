...
public class PmsComment implements Serializable {
    ...
    @ApiModelProperty(value = "comment star：0->5")
    private Integer star;

    @ApiModelProperty(value = "comment ip")
    ...
    @ApiModelProperty(value = "upload pictures, separate with comma")
    private String pics;

    @ApiModelProperty(value = "comment member icon")
