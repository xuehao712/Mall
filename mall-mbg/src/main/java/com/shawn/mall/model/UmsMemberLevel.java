...
public class UmsMemberLevel implements Serializable {
    ...
    @ApiModelProperty(value = "whether default level：0->no；1->yes")
    private Integer defaultStatus;

    @ApiModelProperty(value = "free shipping point")
    private BigDecimal freeFreightPoint;

    @ApiModelProperty(value = "comment retrive growth")
    private Integer commentGrowthPoint;

    @ApiModelProperty(value = "whether free shipping")
    private Integer priviledgeFreeFreight;

    @ApiModelProperty(value = "whether signin privilege")
    private Integer priviledgeSignIn;

    @ApiModelProperty(value = "whether comment prize privilege")
    private Integer priviledgeComment;

    @ApiModelProperty(value = "whether promotion privilege")
    private Integer priviledgePromotion;

    @ApiModelProperty(value = "whether member price privilege")
    private Integer priviledgeMemberPrice;

    @ApiModelProperty(value = "whether birthday privilege")
