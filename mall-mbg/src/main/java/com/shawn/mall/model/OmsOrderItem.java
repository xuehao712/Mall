...
public class OmsOrderItem implements Serializable {
    ...
    @ApiModelProperty(value = "sale quantity")
    ...
    @ApiModelProperty(value = "product catogory id")
    ...
    @ApiModelProperty(value = "coupon price")
    private BigDecimal couponAmount;

    @ApiModelProperty(value = "integration price")
    private BigDecimal integrationAmount;

    @ApiModelProperty(value = "after all price")
    ...
    @ApiModelProperty(value = "product attributes:[{'key':'color','value':'blue/green/etc'},{'key':'capacity','value':'4G'}]")
