 ...
 */
@Controller
@Api(tags = "HomeController",description = "Home page content management")
@RequestMapping("/home")
public class HomeController {
    @Autowired
    private HomeService homeService;

    @ApiOperation("Home page content info display")
    ...
    @ApiOperation("Paging get recommend product")
    ...
    @ApiOperation("Get home page product category")
    ...
    @ApiOperation("Get subject base on category")
    ...
    @ApiOperation("Paging get hot recommend product")
    ...
    @ApiOperation("Paging get new product")
