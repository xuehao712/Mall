...
import com.shawn.mall.dto.UmsAdminLoginParam;
 ...
 */
@Controller
@Api(tags = "UmsAdminController", description = "admin user ")
...
public class UmsAdminController {
    ...
    @ApiOperation(value = "get current login user info")
    ...
    @ApiOperation("get user list base on username or name")
    ...
    @ApiOperation("get single user info")
    ...
    @ApiOperation("modify single user")
    ...
    @ApiOperation("modify user password")
    ...
    public CommonResult updatePassword(@RequestBody UpdateAdminPasswordParam updatePasswordParam) {
        ...
        if (status > 0) {
            ...
            return CommonResult.failed("param is invalid");
        } else if (status == -2) {
            return CommonResult.failed("cannot find this user");
        } else if (status == -3) {
    ...
    @ApiOperation("delete single user info")
    ...
    @ApiOperation("assign admin a role")
    ...
    @ApiOperation("get admin role list")
    ...
    @ApiOperation("+ or - admin permission")
    ...
    @ApiOperation("get admin all permission")
