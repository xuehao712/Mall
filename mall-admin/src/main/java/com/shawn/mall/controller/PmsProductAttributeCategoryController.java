...
import com.shawn.mall.service.PmsProductAttributeCategoryService;
 ...
 */
@Controller
@Api(tags = "PmsProductAttributeCategoryController", description = "Product attribute category")
...
public class PmsProductAttributeCategoryController {
    ...
    @ApiOperation("Modify product attribute category")
    ...
    @ApiOperation("Paging get all list")
    ...
    @ApiOperation("Get all product attributes category and its child")
