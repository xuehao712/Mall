 ...
 */
@Controller
@Api(tags = "PmsBrandController", description = "Product brand")
...
public class PmsBrandController {
    ...
    @ApiOperation(value = "Get paging brand list base on brand key word")
    ...
    @ApiOperation(value = "Get brand base on id")
    ...
    @ApiOperation(value = "Multiple delete brand")
    ...
    @ApiOperation(value = "Mutiple update status")
    ...
    @ApiOperation(value = "Multiple update factory status")
