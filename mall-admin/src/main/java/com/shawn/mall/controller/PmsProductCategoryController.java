 ...
 */
@Controller
@Api(tags = "PmsProductCategoryController", description = "product category")
...
public class PmsProductCategoryController {
    ...
    @ApiOperation("paging get product category")
    ...
    @ApiOperation("modify nav status")
    ...
    @ApiOperation("search all level one category and its child")
