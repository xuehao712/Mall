 ...
 */
@Controller
@Api(tags = "OmsOrderReturnApplyController", description = "Order return application")
@RequestMapping("/returnApply")
public class OmsOrderReturnApplyController {
    @Autowired
    private OmsOrderReturnApplyService returnApplyService;

    @ApiOperation("Paging get return application")
    ...
    @ApiOperation("Modify return status")
