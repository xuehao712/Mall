...
/**
 * flash and product relation Controller
 */
@Controller
@Api(tags = "SmsFlashPromotionProductRelationController", description = "flash and product relation")
@RequestMapping("/flashProductRelation")
public class SmsFlashPromotionProductRelationController {
    @Autowired
    private SmsFlashPromotionProductRelationService relationService;

    @ApiOperation("multiple create relation")
    ...
    @ApiOperation("modify relate info")
    ...
    @ApiOperation("get product promotion info")
    ...
    @ApiOperation("paging get different flash session relation and product ")
