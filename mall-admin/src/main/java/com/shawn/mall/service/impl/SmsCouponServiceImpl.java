...
import com.shawn.mall.dao.SmsCouponDao;
import com.shawn.mall.dao.SmsCouponProductCategoryRelationDao;
import com.shawn.mall.dao.SmsCouponProductRelationDao;
import com.shawn.mall.dto.SmsCouponParam;
import com.shawn.mall.mapper.SmsCouponMapper;
import com.shawn.mall.mapper.SmsCouponProductCategoryRelationMapper;
...
public class SmsCouponServiceImpl implements SmsCouponService {
    ...
    public int create(SmsCouponParam couponParam) {
        ...
        // insert coupon and product relation
    ...
    public int update(Long id, SmsCouponParam couponParam) {
        ...
        //delete and then insert product relation
        if(couponParam.getUseType().equals(2)){
            for(SmsCouponProductRelation productRelation:couponParam.getProductRelationList()){
                productRelation.setCouponId(couponParam.getId());
            }
        ...
        //delete and then insert product category relation
        if(couponParam.getUseType().equals(1)){
            for (SmsCouponProductCategoryRelation couponProductCategoryRelation : couponParam.getProductCategoryRelationList()) {
                couponProductCategoryRelation.setCouponId(couponParam.getId());
            }
